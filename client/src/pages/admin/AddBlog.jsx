      ...
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded '>
        ...
        <label htmlFor="image">
          ...
          <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
            ...
            <button disabled={loading} type='button' onClick={generateContent} className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70
            px-4 py-1.5 rounded hover:underline cursor-pointer'>Generate with AI</button>
          </div>
